...
const products = [
  {
    id: 1,
    name: 'Cuadro de madera',
    price: 500,
    image: './assets/img/cuadro.jpeg',
    description: 'Cuadro de madera con luz cálida - 20x20, mas conector a corriente electrica'
  },
  {
    id: 2,
    name: 'Lámpara led - Base negra ',
    price: 500,
    image: './assets/img/negra.jpeg',
    description: 'Lámpara led de 16 colores diferentes, control remoto y cable de carga'
  },
  {
    id: 3,
    name: 'Lámpara led - Base de madera',
    price: 420,
    image: './assets/img/madera.jpeg',
    description: 'Lámpara led de 1 sólo color (luz cálida o luz fría)'
  },

  {
    id: 4,
    name: 'Lámpara led - Base Blanca',
    price: 350,
    image: './assets/img/blanca.jpeg',
    description: 'Lámpara led de 7 colores diferentes'
  }
]
...
checkout.addEventListener('click', function (e) {
  ...
  if(e.target.closest('.wrapper__sidebar-cart-btn-link')) {
    alert('Gracias por tu compra en Etail Shop')
    cart = []
    renderCart()
  }
